...
Data = pd.read_csv(r'# Path to GaN_S2.csv')
Training_Data = pd.DataFrame( Data, columns = [ 'Substrate Temperature (Celsius)' , 'Gallium Temperature (Celsius)' , 'Chamber Pressure (torr)' , 'RF Plasma Power (W)' , 'S2' ] )
Training_Data = Training_Data.sample( frac = 1 )
Training_and_Testing_Data = Training_Data.iloc[ :50 , : ]
Inputs = Training_and_Testing_Data.loc[ : , [ 'Substrate Temperature (Celsius)' , 'Gallium Temperature (Celsius)' , 'Chamber Pressure (torr)' , 'RF Plasma Power (W)' ] ]
Output = Training_and_Testing_Data.loc[ : , [ 'S2' ] ]
...
Validation_Data = Training_Data.iloc[ 50: , : ]
Validation_Inputs = Validation_Data.loc[ : , [ 'Substrate Temperature (Celsius)' , 'Gallium Temperature (Celsius)' , 'Chamber Pressure (torr)' , 'RF Plasma Power (W)' ] ]
Validation_Output = Validation_Data.loc[ : , [ 'S2' ] ]
