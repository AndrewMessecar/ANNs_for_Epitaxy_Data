...
Data = pd.read_csv(r'/home/garibasen/Documents/Data/WMU/Dropbox/Crystallinity/GaN/GaN_Temp_Crystal.csv')
Training_Data = pd.DataFrame( Data, columns = [ 'Substrate Temperature (Celsius)' , 'Gallium Temperature (Celsius)' , 'Chamber Pressure (torr)' , 'RF Plasma Power (W)' , 'Growth Time (minutes)' , 'Crystal' ] )
Training_Data = Training_Data.sample( frac = 1 )
Training_and_Testing_Data = Training_Data.iloc[ :100 , : ]
Inputs = Training_and_Testing_Data.loc[ : , [ 'Substrate Temperature (Celsius)' , 'Gallium Temperature (Celsius)' , 'Chamber Pressure (torr)' , 'RF Plasma Power (W)' , 'Growth Time (minutes)' ] ]
...
Validation_Inputs = Validation_Data.loc[ : , [ 'Substrate Temperature (Celsius)' , 'Gallium Temperature (Celsius)' , 'Chamber Pressure (torr)' , 'RF Plasma Power (W)' , 'Growth Time (minutes)' ] ]
